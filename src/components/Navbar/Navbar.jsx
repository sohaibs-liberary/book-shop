...
const Navbar = () => {
    return (
        <div className='shadow-lg bg-slate-300 text-black dark:bg-gray-900 dark:text-white duration-200  '  >
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-4" >
                        ...
                        hover:text-purple-600 duration-200" >{menu.name}</a>
                         ...
                         <button className='bg-gradient-to-r   from-purple-600 to-pink-400 text-white px-6 py-2 rounded-full flex items-center gap-3  text-xl hover:scale-105 duration-150 '>
